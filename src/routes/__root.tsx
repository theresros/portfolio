...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Theresrose Vilsan, B.Tech Software Engineering student at Christ College of Engineering specializing in Full Stack Development." },
      { name: "author", content: "Theresrose Vilsan" },
      { property: "og:title", content: "Theresrose Vilsan — Full Stack Developer" },
      { property: "og:description", content: "B.Tech student building scalable web applications and solving real-world problems through technology." },
